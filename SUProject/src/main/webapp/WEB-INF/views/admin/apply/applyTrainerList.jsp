...
<body>
	...
	<table class="table table-bordered">
		...
		<c:forEach items="${list }" var="applyTrainerVO">
			<tr class="rowdata">
				<td class="userid">${applyTrainerVO.userid }</td>
	...
	<script>
		$(function() { // onready - html의 body 부분의 내용이 다 로딩되면 동작되도록 한다.
			...
			$(".rowdata").click(function() { // rowdata 클래스가 클릭되면 function 실행
				location = '/admin/apply/viewApplyTrainer?userid=' + $(this).find(".userid").text();
			})
		});
	</script>
</body>
